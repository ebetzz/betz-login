...
-28 36 -767 782 -1644 1659 l-1595 1594 -11 -39z" />
                        ...
                        <form action="{{ route('forgotPassword.submit') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" id="email" name="email" class="form-control @error('username') is-invalid @enderror" required>
                            </div>
                    ...
                    <div class="card-footer py-3 border-0">
                        ...
                        <div class="text-center">
                            <div class="text-center">
                                Go back to <a href="{{ route('login.index') }}" class="text-dark">Login here</a>
                            </div>
                        </div>
                    </div>
                </div>
